...
@Component({
  selector: 'brave-tradelines-dispute-personal-information-pure',
  templateUrl: './tradelines-dispute-personal-information-pure.component.html',
})
export class TradelinesDisputePersonalInformationPureComponent implements OnInit {
