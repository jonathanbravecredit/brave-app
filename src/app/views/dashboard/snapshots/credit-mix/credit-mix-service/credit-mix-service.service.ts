    ...
    if (tradeLineSummary?.totalLineAmount) {
      if (
        tradeLineSummary.totalLineAmount - tradeLineSummary.amountOfClosed <=
          1 && // Only 1 account of any type open
        !tradeLineSummary.amountOfClosed // No accounts shown, open or closed
      ) {
        return { rating: "Poor", color: "#F56700" };
      } else if (
        tradeLineSummary.totalLineAmount - tradeLineSummary.amountOfClosed <=
          4 || // 2-4 accounts of any type open
        ...
        return { rating: "Fair", color: "#F59300" };
      } else if (
        (tradeLineSummary.totalLineAmount - tradeLineSummary.amountOfClosed <=
        ...
        return { rating: "Good", color: "#BBD904" };
      } else if (
        tradeLineSummary.totalLineAmount - tradeLineSummary.amountOfClosed >=
          8 && // 8+ accounts of any type open
        ...
        return { rating: "Excellent", color: "#4BD269" };
      } else {
