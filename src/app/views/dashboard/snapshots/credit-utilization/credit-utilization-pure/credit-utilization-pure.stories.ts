...
import { CreditUtilizationAssessmentComponent } from '@views/dashboard/snapshots/credit-utilization/components/credit-utilization-assessment/credit-utilization-assessment.component';
...
Default.args = {
  creditAcounts: [testPartition, testPartition, testPartitionTwo],
  hasCards: true,
  debtAmount: 5000,
  totalAmount: 15000,
  utilizationPerc: 25,
