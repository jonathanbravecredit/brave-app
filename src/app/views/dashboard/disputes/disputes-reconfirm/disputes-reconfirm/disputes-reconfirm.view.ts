...
export class DisputesReconfirmView {
  ...
  onDisputePersonalClick(personalItem: IPersonalItemsDetailsConfig): void {
    ...
    this.router.navigate(
      [
        routes.root.children.dashboard.children.disputes.children.personalitem
          .full,
      ],
      {
        queryParams: {
  ...
  onDisputePublicClick(publicItem: IPublicPartition): void {
    ...
    this.router.navigate(
      [
        routes.root.children.dashboard.children.disputes.children.publicitem
          .full,
      ],
      {
        queryParams: {
  ...
  onDisputeTradelineClick(tradeline: ITradeLinePartition): void {
    ...
    this.router.navigate(
      [
        routes.root.children.dashboard.children.disputes.children.tradeline
          .full,
      ],
      {
        queryParams: {
