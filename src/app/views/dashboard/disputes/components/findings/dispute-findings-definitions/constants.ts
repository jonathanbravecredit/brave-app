...
export const DEFAULT_FINDINGS_DEFINITIONS_FOR_ACCOUNTS: IFindingsDefinition[] = [
  ...
  {
    title: 'Original Charge-Off',
    description: 'If applicable, the amount charged off due to non-payment of the account',
  },
  ...
  {
    title: 'Remarks',
    description: 'If applicable, the creditor may provide additional information here related to the account',
  },
  { title: 'Last Payment Made', description: 'The date the creditor received the last payment on the account' },
  {
    title: 'Responsibility',
    description: 'The type of contractual ownership (individual, joint, authorized user, etc.) of the account',
  },
  {
    title: 'Maximum Delinquency',
    description:
      'If applicable, the maximum amount past due before an account becomes a charge-off or a collection account',
  },
