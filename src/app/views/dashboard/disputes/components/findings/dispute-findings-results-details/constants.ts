import { IInvestigationResultInfo, TInvestigationResultCode } from './interfaces';

// export const DEFAULT_INVESTIGATION_RESULT_TYPES: IInvestigationResultInfo[] = [
//   {
//     type: 'deleted',
//     title: 'INVESTIGATION RESULTS - DELETED: ',
//     subtitle: 'The disputed item(s) was removed from your credit report.',
//     description: 'In response to your dispute, this item was <b>DELETED</b> from your credit report.',
//   },
//   {
...
//     subtitle:
//       'This previously deleted item(s) has been verified; therefore, it has been added back to your credit report.',
//     description:
//       'We investigated the information you disputed and this previously deleted item has now been verified and ADDED back to your credit report',
...
//     subtitle:
//       'The disputed item(s) was verified as belonging to you and information has changed or been updated to reflect recent activity.',
...
//     description:
//       'We investigated the information you disputed and the disputed information was VERIFIED AS ACCURATE; however, we updated: ',
//     detailDescription: 'Here is how this account appears on your credit report following our investigation.',
//   },
//   {
//     type: 'personal_item',
//     title: 'INFORMATION UPDATED: ',
//     subtitle: 'In response to your request, a change was made to this item(s).',
//     description: 'This section of your report was updated as follows: ',
//     detailDescription: '',
//   },
// ];

export const DEFAULT_INVESTIGATION_RESULT_TYPES_NEW: Record<TInvestigationResultCode, IInvestigationResultInfo> = {
  deleted: {
    title: 'INVESTIGATION RESULTS - DELETED: ',
    subtitle: 'The disputed item(s) was removed from your credit report.',
    description: 'In response to your dispute, this item was <b>DELETED</b> from your credit report. ',
