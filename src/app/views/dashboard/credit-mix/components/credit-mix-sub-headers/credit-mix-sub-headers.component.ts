...
export class CreditMixSubHeadersComponent implements OnInit {
  ...
  config: IBaseModalSmallConfig = {
    ...
    body: "If you do not see all of your accounts, it may be because the lender doesn’t report that account to TransUnion. Many lenders report payments to only one or two of the major credit bureaus, TransUnion, Equifax, and Experian.",
    subBody:
