...
const onboarding = routes.root.children.onboarding;
...
const OnboardingRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: onboarding.children.name.segment,
        component: KycWelcomeComponent,
        canDeactivate: [KycDeactivateGuard],
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.address.segment,
        component: KycAddressComponent,
        canDeactivate: [KycDeactivateGuard],
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.identity.segment,
        component: KycSsnComponent,
        canDeactivate: [KycDeactivateGuard],
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.identityfull.segment,
        component: KycSsnFullComponent,
        canDeactivate: [KycDeactivateGuard],
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.verify.segment,
        component: KycPhonenumberComponent,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.code.segment,
        component: KycIdverificationComponent,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.kba.segment,
        component: KycKbaquestionsComponent,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.congratulations.segment,
        component: KycCongratulationsComponent,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.returning.segment,
        component: KycWelcomebackComponent,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.error.segment,
        component: KycExceptionsView,
        canActivate: [ActiveGuard, AuthGuard],
      },
      {
        path: onboarding.children.retry.segment,
