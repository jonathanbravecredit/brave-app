...
import { ComplianceTosComponent } from '@views/compliance-tos/compliance-tos.component';
import { CompliancePrivacyComponent } from '@views/compliance-privacy/compliance-privacy.component';
