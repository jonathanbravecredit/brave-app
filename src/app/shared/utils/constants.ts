...
export const DateBreachCard: Record<any, IBreachCard> = {
  [DataBreaches.Condition1]: {
    ...
    paragraphs: [
      `<p> In February 2021, at least 38 million records from the California DMV were compromised through a billing contractor, Automatic Funds Transfer Services. Information leaked includes 20 months’ worth of CA vehicle registration records such as names, addresses, license place numbers, and vehicle identification numbers (VINS) from at least August 2019.</p>`,
    ],
  },
  ...
  [DataBreaches.Condition5]: {
    ...
    paragraphs: [
      `<p>On August 2017, T-Mobile confirmed that the data of 100 million people was stolen, including customers and non-customers who applied for phones. Leaked information includes physical addresses, Social Security information, driver’s license information, and other data.</p>`,
      `<p>If you think you were affected, first <a href="https://www.transunion.com/credit-disputes/dispute-your-credit">review your credit report</a> for accounts you don’t recognize on Brave Credit. If you see something you don’t recognize you can dispute the information, or <a href="https://www.transunion.com/credit-freeze">put a credit freeze</a> on your credit report for all bureaus</p>`,
    ],
  },
